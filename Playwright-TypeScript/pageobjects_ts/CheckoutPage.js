...
var CheckoutPage = /** @class */ (function () {
    ...
    CheckoutPage.prototype.assertOrderText = function (orderCompletedText) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                (0, test_1.expect)(this.orderCompletedText).toHaveText(orderCompletedText);
                return [2 /*return*/];
            });
        });
    };
    CheckoutPage.prototype.checkoutLastPage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var idOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.orderIdNumber.textContent()];
                    case 1:
                        idOrder = _a.sent();
                        console.log(idOrder);
                        return [2 /*return*/];
